...
const Navbar = () => {
  ...
  useEffect(() => {
    fetch("https://render-1xu5.onrender.com/beauty")
      .then((res) => res.json())
  ...
  useEffect(() => {
    setFilteredProducts(
      products.filter((product) =>
        product.sub.toLowerCase().includes(searchTerm.toLowerCase())
      )
    );
  }, [searchTerm, products]);
    ...
    return (
      <div id="Navbar">
        ...
        <div className="categories">
          <div className="women" onClick={() => navigate("/")}>
            {" "}
            WOMEN
          </div>
          ...
          <div className="beauty" onClick={() => navigate("/beauty")}>
            {" "}
            BEAUTY
          </div>
          ...
          <div className="homehide">
            <div className="flex">
              ...
              <div>
                ...
                <h5>TECHNOLOGY</h5>
                <img
                  src="https://modesens.com/banner/9368/getimg/?img=%2Fbanner%2F20210816Home-Technology-Nav.jpg"
                  alt=""
                />
              </div>
            </div>
          ...
          <div style={{ color: "red" }} className="offers">
            {" "}
            SALE
          </div>
          ...
          <div style={{ color: "red" }} className="designer">
            {" "}
            GIFT SIDE
          </div>
        </div>
        <div className="right_side ">
          ...
          >
            <button
              style={{ marginLeft: "955px", marginTop: "-1px" }}
              onClick={closeModal}
            >
              <CloseIcon w={5} h={8} />
            </button>
            <div style={{ display: "flex" }}>
              <div className="j">
                <img
                  className="i"
                  src="https://i.ibb.co/T82y0C4/Screenshot-312.png"
                  alt=""
                />
              </div>
              <div style={{ width: "500px", textAlign: "center" }}>
                ...
                <form onSubmit={handleSubmit} action="">
                  ...
                  />
                  <Checkbox style={{ marginTop: "20px", fontSize: "5px" }}>
          ...
          <div id="loginhide">
            ...
            <hr></hr>
            {user ? (
              <h5 onClick={handleLogout} className="inbtn">
                Logout
              </h5>
            ) : (
              <h5 onClick={openModal2} className="inbtn">
                Login
              </h5>
            )}
          </div>
            ...
            {searchTerm && (
              ...
              >
                {filteredProducts.slice(0, 5).map((product) => (
                  <Link key={product.id} to={`/beauty/${product.id}`}>
                    <div
                      style={{
                        display: "flex",
                    ...
                    >
                      ...
                      <p>{product.sub.substring(0, 20)}...</p>
                    </div>
                  </Link>
                ))}
              </div>
